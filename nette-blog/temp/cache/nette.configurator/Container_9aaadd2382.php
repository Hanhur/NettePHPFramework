...
class Container_9aaadd2382 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'Nette\Application\UI\Presenter' => [
			2 => ['application.1', 'application.2', 'application.3', 'application.4', 'application.5', 'application.7'],
		],
		...
		'App\Modules\Admin\Presenters\BaseAdminPresenter' => [2 => ['application.1', 'application.2', 'application.3']],
		'App\Modules\Admin\Presenters\DashboardPresenter' => [2 => ['application.2']],
		'App\Modules\Admin\Presenters\SignPresenter' => [2 => ['application.3']],
		'App\Modules\Front\Presenters\HomePresenter' => [2 => ['application.4']],
	...
	public function createServiceApplication__1(): App\Modules\Admin\Presenters\BaseAdminPresenter
	{
		$service = new App\Modules\Admin\Presenters\BaseAdminPresenter;
	...
	public function createServiceApplication__2(): App\Modules\Admin\Presenters\DashboardPresenter
	{
		$service = new App\Modules\Admin\Presenters\DashboardPresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__3(): App\Modules\Admin\Presenters\SignPresenter
	{
		$service = new App\Modules\Admin\Presenters\SignPresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__4(): App\Modules\Front\Presenters\HomePresenter
	{
		$service = new App\Modules\Front\Presenters\HomePresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceAssets__registry(): Nette\Assets\Registry
	{
		...
		$service->addMapper(
			...
			rtrim(Nette\Utils\FileSystem::resolvePath('D:\NettePHPFramework\nette-blog\www', 'assets'), '\/'),
			[],
			true,
		),
		);
	...
	{
		$service = new Nette\Database\Connection('sqlite:./db.sqlite3', null, null, []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_9aaadd2382 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('D:\NettePHPFramework\nette-blog/temp/cache/latte');
